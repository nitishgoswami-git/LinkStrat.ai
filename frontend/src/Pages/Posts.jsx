  ...
  const [posts] = useState([
    {
      ...
      title: "Groq 10x faster inference!",
      content: "Groq's LPU architecture revolutionizing AI...",
      status: "posted",
      postedAt: "Dec 25, 10:00 AM",
      linkedinUrl: "#",
      impressions: 247,
      likes: 23,
      comments: 8,
    ...
    },
    {
      id: 2,
      campaign: "AI Trends 2025",
      title: "LangGraph 2.0 Agents",
      content: "Stateful agents now production-ready...",
      status: "posted",
      postedAt: "Dec 24, 10:00 AM",
      linkedinUrl: "#",
      impressions: 189,
      likes: 15,
      comments: 5,
    ...
    },
    {
      ...
      campaign: "SEO Tips",
      title: "SEO Tips",
      content: "Google algorithm prioritizes E-E-A-T...",
      status: "failed",
      postedAt: "Dec 23, 9:00 AM",
    ...
    },
    {
      ...
      content: "Google performance metrics stricter...",
      status: "queued",
          ...
          <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 sm:gap-6 mb-6 sm:mb-8">
                ...
                <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0">
                  <div className="relative group w-72 sm:w-96 flex-shrink-0">
                    ...
                    />
                    <svg
                      className="w-5 h-5 text-gray-400 absolute left-4 top-1/2 -translate-y-1/2 group-focus-within:text-blue-500 transition-colors pointer-events-none"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {[
                ...
                {
                  label: "Queued",
                  value: posts.filter((p) => p.status === "queued").length,
                  color: "blue",
                },
                {
                  label: "Failed",
                ...
                <div
                  key={i}
                  className={`bg-gradient-to-br from-${stat.color}-50 to-${stat.color}-100 border-4 border-${stat.color}-200/80 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-2xl hover:shadow-3xl hover:-translate-y-3 transition-all duration-300 group`}
                >
                  <div
                    className={`text-3xl sm:text-4xl font-black text-${stat.color}-600 mb-2 group-hover:scale-110 transition-transform`}
                  >
                    {stat.value}
                  </div>
                  <p
                    className={`text-sm sm:text-base font-bold text-${stat.color}-800 uppercase tracking-wide`}
                  >
                    {stat.label}
                  </p>
                </div>
                  ...
                  <thead>
                    <tr className="bg-gradient-to-r from-gray-50 to-gray-100">
                      {[
                        ...
                        <th
                          key={i}
                          className={`px-4 sm:px-6 sm:py-4 lg:py-6 text-left font-black text-gray-700 uppercase tracking-widest text-xs sm:text-sm ${
                    ...
                    {filteredPosts.map((post) => (
                      ...
                      >
                        ...
                        <td className="px-4 sm:px-6 sm:py-4 lg:py-6 hidden lg:table-cell">
                          <span
                            className={`px-4 sm:px-6 py-2 sm:py-3 rounded-2xl font-bold text-sm shadow-lg ${getStatusColor(
                              post.status
                            )}`}
                          >
                        ...
                        <td className="px-4 sm:px-6 sm:py-4 lg:py-6 text-right">
                          <div className="flex items-center justify-end gap-2">
                            {post.linkedinUrl ? (
                              ...
                              <span className="px-4 py-2.5 text-gray-400 font-bold text-sm">
                                —
                              </span>
                            )}

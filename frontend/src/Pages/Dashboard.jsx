  ...
  const campaigns = [
    {
      id: 1,
      name: "AI Trends 2025",
      topic: "Latest AI developments, LLM agents, and automation trends",
      schedule: "Daily • 10AM",
      isActive: true,
      postsSent: 127,
      nextPost: "2 hours",
      nextPreview: "AI agents revolutionizing workflows...",
    },
  ];
        ...
        component2={
          <main className="flex-1 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-4 sm:p-8 overflow-auto">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                <div>
                  ...
                  <p className="text-lg sm:text-xl text-gray-600 font-semibold">
                    Manage your automated LinkedIn posts
                  </p>
                </div>
                <button 
                  onClick={handleNewCampaign}
                  className="px-8 py-4 sm:px-10 sm:py-5 bg-gradient-to-r from-emerald-500 to-teal-600 text-white text-base sm:text-lg font-bold rounded-3xl shadow-2xl hover:shadow-3xl hover:scale-105 transition-all duration-300 border border-emerald-200 whitespace-nowrap"
                >
                  + New Campaign
                </button>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8">
              {/* Campaign Card 1 - Click to Edit */}
              <div 
                className="bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 border border-white/50 hover:shadow-2xl transition-all hover:-translate-y-3 cursor-pointer group"
                onClick={() => handleEdit(campaigns[0])}
              >
                <div className="flex items-start justify-between mb-4 sm:mb-6">
                  <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                    <div className="w-3 h-3 sm:w-4 sm:h-4 bg-emerald-500 rounded-full animate-pulse flex-shrink-0"></div>
                    <h3 className="text-xl sm:text-2xl font-black text-gray-900 group-hover:text-indigo-600 truncate pr-2">
                      AI Trends 2025
                    </h3>
                  </div>
                  <span className="px-3 py-1 sm:px-4 sm:py-2 bg-emerald-100 text-emerald-800 text-xs sm:text-sm font-bold rounded-2xl whitespace-nowrap flex-shrink-0">
                    Active
                  </span>
                </div>
                <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  <p className="text-gray-600 leading-relaxed text-sm sm:text-base line-clamp-2">
                    "Latest AI developments, LLM agents, and automation trends"
                  </p>
                  <div className="flex items-center justify-between text-base sm:text-lg font-semibold text-sm sm:text-base">
                    ...
                    <span className="text-emerald-600 flex items-center gap-1 text-xs sm:text-sm">
                      📈 Trends
                    </span>
                  </div>
                ...
                <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-all">
                  <button className="flex-1 bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-2 px-4 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all text-sm">
                    Preview
                  </button>
                  <button className="p-2 bg-gray-100 hover:bg-gray-200 rounded-2xl transition-all flex-shrink-0">
              ...
              <div className="lg:col-span-1 xl:col-span-2 bg-white/60 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-8 sm:p-12 border-2 border-dashed border-gray-200 text-center hover:border-indigo-300 transition-all group col-span-full lg:col-auto">
                ...
                <h3 className="text-xl sm:text-2xl font-black text-gray-700 mb-3">
                  Ready to automate?
                </h3>
                <p className="text-gray-600 mb-8 max-w-md mx-auto text-sm sm:text-base">
                  Create your first campaign to start generating and posting AI-powered LinkedIn content automatically.
                </p>
                <button 
                  onClick={handleNewCampaign}
                  className="px-8 sm:px-12 py-3 sm:py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white text-base sm:text-lg font-bold rounded-3xl shadow-2xl hover:shadow-3xl hover:scale-105 transition-all"
                >

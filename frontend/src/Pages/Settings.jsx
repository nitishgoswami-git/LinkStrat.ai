                ...
                {isConnected && !isEditing ? (
                  <div className="border-4 border-emerald-200/80 rounded-2xl sm:rounded-3xl p-8 sm:p-10 text-center">
                    <div className="w-20 h-20 sm:w-24 sm:h-24 bg-emerald-500/20 rounded-2xl sm:rounded-3xl flex items-center justify-center mx-auto mb-6 sm:mb-8 shadow-2xl ring-4 ring-emerald-200/50">
                      <svg
                        className="w-12 h-12 sm:w-16 sm:h-16 text-emerald-600 drop-shadow-lg"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <button
                      ...
                      className="mt-6 sm:mt-8 px-8 sm:px-10 py-3 bg-gradient-to-br from-orange-500 to-red-500 text-white font-bold text-base sm:text-lg rounded-xl sm:rounded-2xl shadow-2xl hover:shadow-3xl hover:scale-105 transition-all duration-300 border border-emerald-300"
                    >
                      Edit Key
                    </button>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-4 sm:px-6 py-4 sm:py-6 text-lg sm:text-xl border-2 border-gray-200 rounded-2xl sm:rounded-3xl focus:ring-4 focus:ring-orange-500/30 focus:border-orange-500 transition-all duration-300 shadow-xl bg-white/60 placeholder-gray-500 font-mono tracking-wide pr-32"
                        />
